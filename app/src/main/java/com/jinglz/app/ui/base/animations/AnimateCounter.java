 ...
 */
package com.jinglz.app.ui.base.animations;
...
public class AnimateCounter {
    ...
    public void execute() {
        ...
        mValueAnimator.addUpdateListener(valueAnimator -> {
            final String current = NumberUtils.toPrettyNumber(valueAnimator.getAnimatedValue());
            mView.setText(current);
        });
